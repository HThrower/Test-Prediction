...
table(prf,ptree)
```
Based on the dataset created and evaluated witht he help of the random forest model and hte Tree model. I feel confident that the most accurate model for testing dataset in the random forest model
```{r,echo=TRUE}
